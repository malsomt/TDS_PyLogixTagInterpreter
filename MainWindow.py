...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/path/icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btn_connect.setMinimumSize(QtCore.QSize(93, 21))
        ...
        self.btn_disconnect.setMinimumSize(QtCore.QSize(93, 21))
