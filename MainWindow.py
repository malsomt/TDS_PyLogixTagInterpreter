...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.lst_components.isSortingEnabled()
        self.lst_components.setSortingEnabled(False)
        item = self.lst_components.item(0)
        item.setText(_translate("MainWindow", "..."))
        self.lst_components.setSortingEnabled(__sortingEnabled)
