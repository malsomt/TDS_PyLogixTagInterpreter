...
class Ui_EditTable(object):
    ...
    def retranslateUi(self, EditTable):
        ...
        self.chkbx_faultSortIn.setToolTip(_translate("EditTable", "<html><head/><body><p>If set, send command will only send the detected changes.</p></body></html>"))
        self.chkbx_faultSortIn.setText(_translate("EditTable", "Edits Only"))
        self.chkbx_faultSortOut.setToolTip(_translate("EditTable", "<html><head/><body><p><span style=\" font-size:9pt;\">Tags read from PLC will be sorted by &quot;Id&quot; in accending order.</span></p></body></html>"))
        ...
        self.chkbx_msgSortIn.setText(_translate("EditTable", "Edits Only"))
        self.chkbx_msgSortOut.setToolTip(_translate("EditTable", "<html><head/><body><p>Tags read from PLC will be sorted by &quot;Id&quot; in accending order.</p></body></html>"))
