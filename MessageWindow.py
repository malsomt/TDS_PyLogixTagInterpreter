...
class Ui_EditTable(object):
    def setupUi(self, EditTable):
        ...
        self.chkbx_msgSort = QtWidgets.QCheckBox(self.groupbox_Message)
        self.chkbx_msgSort.setChecked(True)
        self.chkbx_msgSort.setObjectName("chkbx_msgSort")
        self.horizontalLayout_2.addWidget(self.chkbx_msgSort)
    ...
    def retranslateUi(self, EditTable):
        ...
        self.chkbx_faultSort.setText(_translate("EditTable", "Sort Outgoing"))
        ...
        self.chkbx_msgSort.setToolTip(_translate("EditTable", "<html><head/><body><p>Tags read from PLC will be sorted by &quot;Id&quot; in accending order.</p></body></html>"))
        self.chkbx_msgSort.setText(_translate("EditTable", "Sort Outgoing"))
